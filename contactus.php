            ...
            <div class="row">
                <div class="col-12">
                    <p>We are always here to help. If your have requirements/queries about our services; fill up the contact form
                       below and we'll do our best to reply within 24 hours Alternatively simply pickup the phone and give us a call.
                    </p>
                    <hr />
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 address">
                    ...
                    <p>
                        <a href="tel:+910192837465"><i class="fas fa-phone"></i> +(91) 0192837465 </a><br>
                    </p>
                    <h5>Email / Website</h5>
                    <p>
                        <a href="mailto:wfmd@gmail.com"><i class="fas fa-envelope"></i> wfmd@gmail.com</a><br>
                        <a href="https://wfmd.tech/"><i class="fas fa-globe"></i></i> www.wfmd.tech </a>
                    </p>
                    <h5>Working hours</h5>
                    <p>
                        Mon - Fri : 9am - 6pm(IST)
                    ...
                    <h5>Address</h5>
                    <p>
                        xzy estate, Royal Palm, station - west, Mumbai - 400000, Maharashtra
                    </p>
                </div>
            </div>
        </div>
