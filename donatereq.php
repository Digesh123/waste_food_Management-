...
<head>
    ...
    <title>Donation Request - WFMD</title>
                    ...
                    <div class="collapse navbar-collapse" id="navbarToggler">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="list.html">NGO List</a>
                                    <a class="dropdown-item" href="policies.html">Policies</a>
                                    <a class="dropdown-item active" href="donatereq.html">Donation Request</a>
                                </div>
                            </li>
        ...
        <div class="container top-footer p-md-3 p-1">
            <div class="row">
                ...
                <div class="col-md-3 pl-4 pr-4">
                    ...
                    <a href="donatereq.html">Donation Request</a><br>
                    <a href="list.html">NGO List</a><br>
                ...
                <div class="col-md-3 pl-4 pr-4">
                    ...
                    <a href="policies.html">Privacy Policy</a><br>
