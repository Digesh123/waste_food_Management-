                    ...
                    <div class="collapse navbar-collapse" id="navbarToggler">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item active" href="donate.php">Donate</a>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 text-center">
                    <img class="img-fluid  qualities-img  p-5" src="images/highquality.png" alt="">
                    <h5>
                        Quality Check
                    </h5>
                    <p>
                ...
                <div class="col-md-4 text-center">
                    <img class="img-fluid  qualities-img  p-5" src="images/support.png" alt="">
                    <h5>
                    Get in touch
                    </h5>
                    <p>
                    Donors with surplus food/resources can reach us at - 919182736450
                    </p>
                </div>
                <div class="col-md-4 text-center">
                    <img class="img-fluid  qualities-img  p-5" src="images/delivery.png" alt="">
                    <h5>
                        Deliver
                    </h5>
                    <p>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-2 col-6">
                    <img class="img-fluid feature-img p-2" src="images/md.png" alt="Card image cap">
                </div>
                <div class="col-md-2 col-6">
                    <img class="img-fluid feature-img p-2" src="images/bk.png" alt="Card image cap">
                </div>
                <div class="col-md-2 col-6">
                    <img class="img-fluid feature-img p-2" src="images/bh.png" alt="Card image cap">
                </div>
                <div class="col-md-2 col-6">
                    <img class="img-fluid feature-img p-2" src="images/pm.jpg" alt="Card image cap">
                </div>
                <div class="col-md-2 col-6">
                    <img class="img-fluid feature-img p-2" src="images/rest.jpg" alt="Card image cap">
                </div>
                <div class="col-md-2 col-6">
                    <img class="img-fluid feature-img p-2" src="images/dom.png" alt="Card image cap">
                </div>
            </div>
