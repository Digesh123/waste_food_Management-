...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="restaurant_posts.php">Restaurant posts </a>
      </li>
...
<div class=" col-12 ">
    <div class="jumbotron">
    <div>
        <h1 class="d-text">ASK_FOR_IT</h1>
        <p class="text1">
        lacking with the food ? <br>
        Let restaurants near you come to know this <br>
        Use create post feature and get a helping hand from restaurants near you!!    
        </p>
  ...
  <div class="col-12 others">
              ...
              <div class="box1 col-5">
                ...
                <h3 class="rounded bg-info font=plane text-center text-white " text>Request food  </h3>
                <p class="textbox">
                  - Congratulations for your work ! <br>
                  - Dont worry with the food lacking !! <br>
                  - Feel free to ask for help<br>
                  - Create post here and take a helping hand from the restaurants near you  <br>
                </p>
               ...
               <a href="ngo_postform.php" class="btn btn-info" role="button" text>click here</a>
             </div>
              ...
              <div class="box1 col-5">
                ...
                <h3 class="rounded bg-info font=plane text-center text-white " text >Your posts </h3>
                    ...
                    <div class="row">
                      <?php foreach($queryngo as $q){ ?>
                          <div class="col-lg-4 d-flex justify-content-center">
                              <div class="card text-white bg-dark mt-5" style="width: 10rem;">
                                  <div class="card-body">
                                      <h5 class="card-title"><?php echo $q['ngoname'];?></h5>
                                      <p class="card-text"><?php echo substr($q['datep'], 0, 50);?>...</p>
                                      <a href="ngo_view.php?id=<?php echo $q['id']?>" class="btn btn-light">Read More <span class="text-danger">&rarr;</span></a>
